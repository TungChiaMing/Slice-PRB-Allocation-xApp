...
- introduce the function about it
    - function `slice_parser` will handle 2. and parse it into how many slice the UE use and which kind of slice the UE use


    - function `uniform_random_slice_prb` is responsible for random the slice PRB to the slice the UE is using
        - the sum of all the slice PRB will be total PRB
...
- example
<div>
<img src="https://github.com/TungChiaMing/SLA-Slice-PRB-Allocation-xApp/blob/e-release/screenshots/example_csv.png" />
</div>
